...
async def main():
    ...
    # 从环境变量读取配置（优先）或使用默认值
    base_url = os.getenv("KD_COSMIC_BASE_URL", "https://api.example.com")
    client_id = os.getenv("KD_COSMIC_CLIENT_ID", "your-client-id")
    client_secret = os.getenv("KD_COSMIC_CLIENT_SECRET", "your-client-secret")
